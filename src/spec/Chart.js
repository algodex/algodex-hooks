...
const colors = DEMO_PRICE_DATA.map(
    ({open, close}) => (open > close ? '#e53e3e2c' : '#2fb16c2c'),
);
...
export const DEMO_VOLUME_DATA = volumeData.map(
    (data, i) => ({...data, color: colors[i]}),
);
export const DEMO_ASSET = {
  id: 15322902, name: 'LAMP', decimals: 6, priceChange24hr: -0.1,
};
export const DEMO_ALGO_VOLUME = '126.8456';
export const DEMO_BASE_ASSET = 'ALGO';
export const DEMO_OHLC = {
  open: 185.6423, high: 209.6563, low: 159.3689, close: 171.6985,
};
