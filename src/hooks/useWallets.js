...
function useWallets() {
  ...
  // const setWalletAddresses = useStorePersisted(
  // (state) => state.setWalletAddresses
  // )
  //
  // const activeWalletAddress = useStorePersisted(
  // (state) => state.activeWalletAddress
  // )
  // const setActiveWalletAddress = useStorePersisted(
  ...
  // ['wallets', addresses], () => WalletService.fetchWallets(addresses), {
