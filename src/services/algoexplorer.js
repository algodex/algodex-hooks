 ...
 *
 * @param id
 * @return {Promise<{circulating, total, decimals, name, verified, txid, fullName, id, url, timestamp, txns}>}
 */
 ...
 *
 * @param asset
 * @return {{score: *, circulating, total, deleted, decimals, name, verified: *, fullName, id, txns}}
 */
 ...
 * @param id
 * @return {Promise<{total, deleted, decimals, name, fullName, id}>}
 */
